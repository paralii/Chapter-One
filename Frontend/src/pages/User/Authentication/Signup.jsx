...
function Signup() {
  ...
  return (
  <div className="w-full h-screen fixed top-0 left-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm px-4 sm:px-6 lg:px-8">
    <div className="relative w-full max-w-[90vw] sm:max-w-[90vw] md:max-w-sm lg:max-w-sm xl:max-w-md bg-white rounded-[30px] p-6 sm:p-8 shadow-xl">
      <button
